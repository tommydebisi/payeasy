...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      // ============================================
      fontFamily: {
        // Body / UI text — loaded via @fontsource-variable/inter
        sans: ["Inter", ...defaultTheme.fontFamily.sans],
        // Display / brand headings — loaded via Google Fonts in layout.tsx
        display: ["Plus Jakarta Sans", "Inter", ...defaultTheme.fontFamily.sans],
        // Monospace — for addresses, hashes, code snippets
